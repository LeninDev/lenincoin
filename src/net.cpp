...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Lenin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"kicks.servep2p.com","kicks.servep2p.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Lenin is probably already running."), addrBind.ToString().c_str());
        else
